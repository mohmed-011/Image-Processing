...
namespace _1
{
    public partial class Form1 : Form
    {
        ...
        {
            Histogram form3 = new Histogram(); // Create an instance of the second form
            this.Hide();               // Hide the current form
            form3.Show();
        }

        private void moreFiltersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            NewFilter form1 = new NewFilter(); // Create an instance of the second form
            this.Hide();               // Hide the current form
            form1.Show();
        }
        ...
        private void MoreFiltersBTN_Click(object sender, EventArgs e)
        {
            NewFilter form1 = new NewFilter(); // Create an instance of the second form
            this.Hide();               // Hide the current form
            form1.Show();
